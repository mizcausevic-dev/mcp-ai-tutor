...
### Released
- Published **mcp-ai-tutor** as a public, portfolio-grade MCP governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **mcp-ai-tutor**.
...
- That insight became the basis for **mcp-ai-tutor**.
